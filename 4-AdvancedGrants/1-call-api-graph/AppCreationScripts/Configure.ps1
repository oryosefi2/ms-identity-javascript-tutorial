...
Function ConfigureApplications
{
   ...
   $serviceAadApplication = New-MgApplication -DisplayName "ms-identity-javascript-tutorial-c4s1-api" `
                                                       -Web `
                                                       @{ `
   ...
   # create the application 
   $spaAadApplication = New-MgApplication -DisplayName "ms-identity-javascript-tutorial-c4s1-spa" `
                                                   -Spa `
                                                   @{ `
    ...
    Update-MgApplication -ApplicationId $spaAadApplication.Id -IdentifierUris @("https://$tenantName/ms-identity-javascript-tutorial-c4s1-spa")
