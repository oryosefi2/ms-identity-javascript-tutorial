...
Function ConfigureApplications
{
   ...
   $spaAadApplication = New-MgApplication -DisplayName "ms-identity-javascript-c1s1" `
                                                   -Spa `
                                                   @{ `
    ...
    Update-MgApplication -ApplicationId $spaAadApplication.Id -IdentifierUris @("https://$tenantName/ms-identity-javascript-c1s1")
